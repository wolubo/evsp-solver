========================================================================
    DYNAMIC LINK LIBRARY: EVSP.Model-Projektübersicht
========================================================================

Diese EVSP.Model-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre EVSP.Model-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen EVSP.Model.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
